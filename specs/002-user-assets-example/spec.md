...
4.  **Scenario: No Assets Found**
    *   **Given**: User "newhire" has no assets.
    *   **When**: I run the program with argument "newhire".
    *   **Then**: The program indicates that 0 assets were found.
